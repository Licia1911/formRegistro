...
export default function FormSignUp({ handleSubmit }) {
    ...
    const [errors, setErrors] = useState({
        name: { error: false, message: "Deben ser a menos 3 caracteres" }
    })
    ...
    function validarNombre(nombre) {
        if (nombre.length >= 3) {
            ...
            return { name: { error: true, message: "Deben ser a menos 3 caracteres" } }
        }
    }
